...
export declare type AuthorPostsArgs = {
...
export declare type AuthorResolvers<ContextType = any, ParentType extends ResolversParentTypes['Author'] = ResolversParentTypes['Author']> = {
